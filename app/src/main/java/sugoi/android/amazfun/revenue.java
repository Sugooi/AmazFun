...
public class revenue extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tt.setText("Revenue in year 2017");
        ...
        barEntryArrayList.add(new BarEntry(122f,0));
        barEntryArrayList.add(new BarEntry(262f,1));
        barEntryArrayList.add(new BarEntry(120f,2));
        barEntryArrayList.add(new BarEntry(320f,3));
        barEntryArrayList.add(new BarEntry(430f,4));
        barEntryArrayList.add(new BarEntry(590f,5));
        barEntryArrayList.add(new BarEntry(330f,6));
        barEntryArrayList.add(new BarEntry(690f,7));
        ...
        entries.add(new Entry(122f,0));
        entries.add(new Entry(262f,1));
        entries.add(new Entry(120f,2));
        entries.add(new Entry(320f,3));
        entries.add(new Entry(430f,4));
        entries.add(new Entry(590f,5));
        entries.add(new Entry(330f,6));
        entries.add(new Entry(690f,7));
        ...
        pieChart.setDescription("Revenue in dollars");
