...
public class salesproducts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tt.setText("Sales of products in year 2017");
        ...
        barEntryArrayList.add(new BarEntry(180f,0));
        barEntryArrayList.add(new BarEntry(60f,1));
        barEntryArrayList.add(new BarEntry(20f,2));
        barEntryArrayList.add(new BarEntry(32f,3));
        barEntryArrayList.add(new BarEntry(130f,4));
        barEntryArrayList.add(new BarEntry(40f,5));
        barEntryArrayList.add(new BarEntry(102f,6));
        ...
        entries.add(new Entry(60f,1));
        entries.add(new Entry(20f,2));
        entries.add(new Entry(32f,3));
        entries.add(new Entry(130f,4));
        entries.add(new Entry(40f,5));
        entries.add(new Entry(102f,6));
